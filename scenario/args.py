...
def get_args(): 
    ...
    parser.add_argument('--metadata_path', type=str, default='./datasets-esc50/ESC-50-master/meta/esc50.csv')
    parser.add_argument('--data_path', type=str, default='./datasets-esc50/ESC-50-master/audio')
    parser.add_argument('--raw_dataset_path', type=str, default='./datasets/esc_raw_dataset/full')
    
    # params for preparing dataset
    parser.add_argument('--splited_dataset_path', type=str, default='./datasets/esc_custom_dataset/train')
    parser.add_argument('--length_audio', type=int, default=2)
    parser.add_argument('--step', type=float, default=0.15)
    parser.add_argument('--dataset_dir', type=str, default='./datasets/esc_custom_dataset/train')
    parser.add_argument('--test_dir', type=str, default='./datasets/esc_custom_dataset/test')
